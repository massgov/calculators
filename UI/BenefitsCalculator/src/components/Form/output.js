...
const Output = (props) => {
  ...
  const helpTextDisqualification2 = `Your total base period wages of ${toCurrency(quartersSum)} must be equal to or greater than ${toCurrency(weeklyBenefitFinal * 26)} (your weekly benefit amount x 26) to be eligible.`;
