...
const Part3 = (props) => {
  ...
  const getTableProps = () => {
    ...
    tRow1.cells[1].text = toCurrency(localFamLeaveComp / thisTimeValue);
    tRow1.cells[1].heading = false;
    tRow1.cells[2].text = toCurrency(localMedLeaveComp / thisTimeValue);
    ...
    tRow2.cells[1].text = toCurrency(localFamLeaveEmp / thisTimeValue);
    tRow2.cells[1].heading = false;
    tRow2.cells[2].text = toCurrency(localMedLeaveEmp / thisTimeValue);
    ...
    tRow3.cells[1].text = toCurrency(localFamLeaveTotal);
    tRow3.cells[1].heading = false;
    tRow3.cells[2].text = toCurrency(localMedLeaveTotal);
